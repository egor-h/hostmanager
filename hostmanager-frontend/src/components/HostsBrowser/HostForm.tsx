...
class HostForm extends React.Component<FormProps, FormState> {
    ...
    render() {
        ...
        <form noValidate autoComplete="off" onSubmit={this.handleSubmit}>
            ...
            <TextField className={classes.margin} value={this.state.address} onChange={this.handleAddressChange} required size="small" id="standard-required" label="Address" defaultValue="" ></TextField>
